                            ...
                            {props.bookCategories.map((term) => {
                                if (props.book.category !== undefined && props.book.category === term)
                                    return <option selected={props.book.category}
                                                   value={props.book.category.value}>{props.book.category}</option>
                                else return <option value={term.value}>{term}</option>
                            ...
                            {props.authors.map((term) => {
                                if (props.book.author !== undefined &&
                                    ...
                                    return <option selected={props.book.author.id}
                                                   value={props.book.author.id}>{props.book.author.name} {props.book.author.surname}</option>
